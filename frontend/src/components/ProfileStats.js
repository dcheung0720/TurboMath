        ...
        <Card.Body >
            <div className = "header" style = {{display: "flex", justifyContent:"space-between", alignItems: "center" }}>
                <div style={{ flex: 1, textAlign: "center" }}>
                    <Card.Title style={{marginBottom: "5px"}}>Personal High Scores</Card.Title>
                </div>
                <span className = "selection" style = {{display: "flex", alignItems: "center", position: "absolute", right: "3px", top: "3px", zIndex: "1000" }}>
                    <div>Difficulty: </div>
